  ...
  return (
    <div className="min-h-screen h-auto">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to right,#003973, transparent), url(${assets.bg_img_5})`,
        }}
      >
        {/*above Navbar */}
        <div className="absolute max-w-screen-2xl mx-auto inset-0 w-10/12 pt-8 md:pt-4 ">
          <div className="absolute w-[100%]">
                ...
                <div className="relative flex w-10/12 max-w-screen-2xl mx-auto justify-between items-center">
                  <div className="h-full w-1/12 ">
                    <img
                      src={assets.logo}
                      alt="Logo"
                      className="sm:w-[90px] h-[80%] w-auto sm:h-[70%]"
                    />
                  </div>
            ...
            <div className="mt-12 w-full h-[70%] sm:mt-12 md:mt-16 fade-in">
              <h1 className="text-[36px] lg:w-5/6 md:text-[50px] lg:text-[70px] font-normal text-white leading-snug sm:leading-none sm:text-left">
